...
const AboutMeSection = () => {
    return (
        <div id="about" className=" w-full  min-h-[100vh] flex flex-col justify-center items-center">
            <div className="max-w-[670] ">

                <h2 className="font-semibold text-xl">About </h2>
                <p className="font-light  text-background/80 leading-[1.8] tracking-normal p-4 ">
